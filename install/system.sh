...
configure_fan_control() {
    ...
    if ! grep -q "cooling_fan=on" "$config_file"; then
        ...
        echo "dtparam=fan_temp0_speed=60" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp1=72000" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp1_hyst=2500" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp1_speed=75" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp2=77000" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp2_hyst=2500" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp2_speed=130" | sudo tee -a "$config_file"
