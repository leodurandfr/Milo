...
configure_fan_control() {
    ...
    if ! grep -q "cooling_fan=on" "$config_file"; then
        ...
        echo "dtparam=fan_temp0_speed=90" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp1=75000" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp1_hyst=2500" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp1_speed=110" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp2=80000" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp2_hyst=2500" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp2_speed=140" | sudo tee -a "$config_file"
