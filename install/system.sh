...
configure_fan_control() {
    ...
    if ! grep -q "cooling_fan=on" "$config_file"; then
        ...
        echo "dtparam=fan_temp0_speed=30" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp1=65000" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp1_hyst=2500" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp1_speed=55" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp2=72000" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp2_hyst=2500" | sudo tee -a "$config_file"
        echo "dtparam=fan_temp2_speed=120" | sudo tee -a "$config_file"
