<template>
    <div class="librespot-player">
      ...
      <DebugPanel 
        ...
        :isDisconnected="audioStore.isDisconnected"
        :manualConnectionStatus="manualConnectionStatus"
        :connectionLastChecked="connectionLastChecked"
        :lastMessages="lastMessages"
        @check-status="checkStatus"
        @refresh-metadata="forceRefreshMetadata"
        @toggle-connection="toggleConnectionStatus"
        @reset-connection="resetConnectionStatus"
      />
...
// Composants - Chemins corrigés
import NowPlayingInfo from './NowPlayingInfo.vue';      // Sans le préfixe 'librespot/'
import PlaybackControls from './PlaybackControls.vue';  // Sans le préfixe 'librespot/'
import ProgressBar from './ProgressBar.vue';            // Sans le préfixe 'librespot/'
import WaitingConnection from './WaitingConnection.vue'; // Sans le préfixe 'librespot/'
