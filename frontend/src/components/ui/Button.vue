...
.btn {
    ...
    border: none;
    cursor: pointer;
    transition: background-color var(--transition-fast), color var(--transition-fast), box-shadow var(--transition-fast), transform 150ms ease-out, opacity 150ms ease-out;
    display: inline-flex;
    align-items: center;
