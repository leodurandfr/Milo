<template>
  <div class="search-view">
    ...
    <MessageContent v-if="store.searchLoading" loading :loading-delay="0" :title="t('musicLibrary.loading')" />

    <template v-else-if="store.hasSearched && !store.searchEmpty">
      <!-- Artists -->
    ...
    <MessageContent v-else icon="search" :title="t('musicLibrary.searchPrompt')" />
  </div>
</template>
