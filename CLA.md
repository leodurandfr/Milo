...
from any person or entity. It protects you as a contributor as well as the project and
its users. It does not change your right to use your own contributions for any other
purpose.

By submitting a Contribution to this project, You accept and agree to the following
terms.
...
or addition to an existing work, that is intentionally submitted by You to this project
for inclusion in, or documentation of, the products managed by the project (the
**"Work"**). *Submitted* means any form of electronic, verbal or written communication
sent to the project or its maintainers, including but not limited to pull requests,
issues and patches.

## 2. Copyright licence

You grant to Léo Durand, and to recipients of software distributed by the project, a
...
You expressly agree that Léo Durand may license Your Contribution under any licence
...
You grant to Léo Durand, and to recipients of software distributed by the project, a
perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable patent licence
...
agreement prevents You from using, licensing or distributing Your own Contributions
elsewhere, under any terms You choose.
...
- Each of Your Contributions is Your original creation, or You otherwise have the
  rights required to submit it.
- If your employer holds rights to intellectual property that You create, You have
  received permission to make the Contribution on behalf of that employer, or your
  employer has waived those rights.
- Your Contributions do not knowingly include third-party material subject to terms
  incompatible with this agreement. If they do, You will identify that material, its
  source and its licence in your submission.
...
would make the representations above inaccurate.
