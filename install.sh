...
source = alsa:///?name=Bluetooth&device=hw:1,1,0&idle_threshold=60000&send_silence=true
source = alsa:///?name=ROC&device=hw:1,1,1&idle_threshold=60000&send_silence=true
source = alsa:///?name=Spotify&device=hw:1,1,2&idle_threshold=60000&send_silence=true
source = alsa:///?name=Radio&device=hw:1,1,3&idle_threshold=60000&send_silence=true
source = alsa:///?name=Podcast&device=hw:1,1,4&idle_threshold=60000&send_silence=true
