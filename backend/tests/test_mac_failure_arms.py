...
`test_mac_source.py` drives the happy resolutions; this file drives
`_run_avahi`'s four failure arms and `_avahi_reverse`'s bad-address guard. The
journal follow and the start path are driven through the measured world in
`test_mac_sessions.py`.
