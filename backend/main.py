...
multiroom_router = create_multiroom_router(client_registry_service, multiroom_equalizer_service, pending_clients_service, crossover_service, snapcast_service)
