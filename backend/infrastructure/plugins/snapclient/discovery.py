...
class SnapclientDiscoveryListener(ServiceListener):
    ...
    def add_service(self, zc: Zeroconf, type_: str, name: str) -> None:
        """Appelé par Zeroconf quand un service est découvert"""
        self.logger.debug(f"Service découvert: {name}")
        # Simplement mettre l'événement dans la queue pour traitement ultérieur
        self.event_queue.put(("add", type_, name, zc))

    def update_service(self, zc: Zeroconf, type_: str, name: str) -> None:
        """Appelé par Zeroconf quand un service est mis à jour"""
        self.logger.debug(f"Service mis à jour: {name}")
        self.event_queue.put(("update", type_, name, zc))

    def remove_service(self, zc: Zeroconf, type_: str, name: str) -> None:
        """Appelé par Zeroconf quand un service est supprimé"""
