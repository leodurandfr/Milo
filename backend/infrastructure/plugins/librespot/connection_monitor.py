# """
# Module de surveillance de connexion pour le plugin librespot.
# """
# import asyncio
# import logging
# import time
...
#         self.polling_interval = polling_interval  # Intervalle de base
...
#         """
#         Vérifie si un appareil est connecté à go-librespot.
...
#             # Vérifier des conditions pour déterminer si on est connecté
...
#                             {"connected": is_connected, "deviceConnected": is_connected}
#                         )
...
#                 except Exception as e:
#                     if "Erreur API (204)" not in str(e):
